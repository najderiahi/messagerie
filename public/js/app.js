  ...
  return _c("div", [
    _c("div", { staticClass: "row" }, [
      _c("div", { class: _vm.cls }, [
        _c("p", [
          _c("strong", [_vm._v(_vm._s(_vm.name) + " " + _vm._s(_vm.user))]),
          _vm._v(" "),
          _c("br"),
          _vm._v(
            "\n                " +
          ...
          [
            _c(
              ...
              [
                ...
                _vm.conversation.unread
                  ? _c(
                      "span",
                      { staticClass: "badge badge-pill badge-primary" },
                      [_vm._v(_vm._s(_vm.conversation.unread))]
                    )
                  : _vm._e()
              ]
            )
    ...
    _c(
      ...
      [
        _vm._l(_vm.messages, function(message) {
          return _c("Message", { attrs: { message: message, user: _vm.user } })
        }),
        _vm._v(" "),
        _c("form", { attrs: { action: "", method: "post" } }, [
          _c("div", { staticClass: "form-group" }, [
            _c("textarea", {
              ...
              attrs: { name: "content", placeholder: "érivez votre message" },
  ...
  mutations: {
    ...
    addConversations: function addConversations(state, _ref2) {
      ...
      conversations.forEach(function (c) {
        ...
        conversation = _objectSpread({}, conversation, {}, c);
        state.conversations = _objectSpread({}, state.conversations, {}, _defineProperty({}, c.id, conversation));
      });
    },
    addMessages: function addMessages(state, _ref3) {
      ...
      state.conversations = _objectSpread({}, state.conversations, {}, _defineProperty({}, id, conversation));
    }
  },
  actions: {
    loadConversations: function () {
      var _loadConversations = _asyncToGenerator(
      /*#__PURE__*/
    ...
    loadMessages: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(context, conversationId) {
        var response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if (context.getters.conversations(conversationId).loaded) {
                  _context3.next = 5;
                  break;
                }
    ...
    sendMessage: function () {
      var _sendMessage = _asyncToGenerator(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(context, _ref4) {
        var content, userId, response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                content = _ref4.content, userId = _ref4.userId;
                _context4.next = 3;
...
__webpack_require__(/*! C:\Users\najd\Desktop\Messagerie\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\najd\Desktop\Messagerie\resources\sass\app.scss */"./resources/sass/app.scss");
